...
pub const MOVES: &[MoveData] = &[
    ...
    MoveData { id: 370, name: "Close Combat", move_type: Type::Fighting, category: MoveCategory::Physical, base_power: 120, accuracy: 100, pp: 5, priority: 0, flags: MoveFlags::new(C), crit_ratio: 0 },
    MoveData { id: 282, name: "Knock Off", move_type: Type::Dark, category: MoveCategory::Physical, base_power: 65, accuracy: 100, pp: 20, priority: 0, flags: MoveFlags::new(C), crit_ratio: 0 },
    MoveData { id: 369, name: "U-turn", move_type: Type::Bug, category: MoveCategory::Physical, base_power: 70, accuracy: 100, pp: 20, priority: 0, flags: MoveFlags::new(C), crit_ratio: 0 },
    ...
    MoveData { id: 229, name: "Rapid Spin", move_type: Type::Normal, category: MoveCategory::Physical, base_power: 50, accuracy: 100, pp: 40, priority: 0, flags: MoveFlags::new(C), crit_ratio: 0 },
    ...
    MoveData { id: 413, name: "Brave Bird", move_type: Type::Flying, category: MoveCategory::Physical, base_power: 120, accuracy: 100, pp: 15, priority: 0, flags: MoveFlags::new(C), crit_ratio: 0 },
    MoveData { id: 442, name: "Iron Head", move_type: Type::Steel, category: MoveCategory::Physical, base_power: 80, accuracy: 100, pp: 15, priority: 0, flags: MoveFlags::new(C), crit_ratio: 0 },
    ...
    MoveData { id: 583, name: "Play Rough", move_type: Type::Fairy, category: MoveCategory::Physical, base_power: 90, accuracy: 90, pp: 10, priority: 0, flags: MoveFlags::new(C), crit_ratio: 0 },
    ...
    MoveData { id: 200, name: "Outrage", move_type: Type::Dragon, category: MoveCategory::Physical, base_power: 120, accuracy: 100, pp: 10, priority: 0, flags: MoveFlags::new(C), crit_ratio: 0 },
