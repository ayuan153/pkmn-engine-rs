...
fn parse_ability(name: &str) -> AbilityId {
    match name {
        ...
        "Rock Head" => AbilityId::RockHead,
        "Sharpness" => AbilityId::Sharpness,
        "Reckless" => AbilityId::Reckless,
        "Mega Launcher" => AbilityId::MegaLauncher,
        "Punk Rock" => AbilityId::PunkRock,
        "Steelworker" => AbilityId::Steelworker,
        "Steely Spirit" => AbilityId::SteelySpirit,
        "Water Bubble" => AbilityId::WaterBubble,
        "Neuroforce" => AbilityId::Neuroforce,
        "Analytic" => AbilityId::Analytic,
        "Stakeout" => AbilityId::Stakeout,
